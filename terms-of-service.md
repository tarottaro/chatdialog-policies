...
- 3日間無料トライアル: 新規購入者向けに、最初の3日間は無料でお試しいただけます
- 月額プラン: ¥100（税込）
- 年額プラン: ¥1,000（税込）

トライアルについて:
- トライアル期間は3日間です
- トライアル期間中は、すべての機能をご利用いただけます
- トライアル期間終了後、自動的に有料プランに移行します
- 同一サブスクリプショングループ内で、トライアルは1回のみ利用可能です
- トライアル期間中にキャンセルした場合、トライアル期間終了までご利用いただけますが、期間終了後は課金されません
...
- 更新時の料金は、購入時と同じ金額です
- トライアル期間終了後、自動的に有料プランに移行し、自動更新が開始されます
...
### 7.2 サービスの終了
開発者は、30日前までに通知することにより、本アプリのサービスを終了できます。
